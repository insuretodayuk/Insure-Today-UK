...
export default function CoverSidebar({
  ...
  const dateOptions = getNextMonthDate();
  return (
    <div className="sidebar-wrap">
      ...
      <div className="sidebar-card">
        ...
        <div className="sidebar-field">
          ...
          <div
            className="select-box select-active"
            style={{ position: "relative" }}
          >
            <div
              className="custom-select"
              onClick={() => setExcessOpen(!excessOpen)}
            >
        ...
        <div className="sidebar-field">
          ...
          {payment === "Monthly" && (
            <p className="field-hint">
              ...
              Paying monthly could be more expensive as an interest charge may
              be included.
            </p>
          )}
        </div>
      ...
      <div className="sidebar-card">
        ...
        {dirty && (
          <button
            className="update-btn update-btn-active addon-update-btn"
            onClick={handleUpdate}
          >
            ✓ Update quotes
          </button>
      ...
      <div className="sidebar-card">
        ...
        <div className="refine-section">
          ...
          {["Plug and drive", "Black box based", "App based", "Other"].map(
            (opt) => (
